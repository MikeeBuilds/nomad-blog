  ...
  return (
    <div className={styles.container}>
      <h1 className={styles.title}>
        <b>Welcome to our bowhunting blog and app!</b> your ultimate guides to
        the wild world of bowhunting. Explore hunting tips, gear reviews, and
      ...
      <div className={styles.post}>
        ...
        <div className={styles.textContainer}>
          <h1 className={styles.}>Learning how to find the deer sign in less time.</h1>
