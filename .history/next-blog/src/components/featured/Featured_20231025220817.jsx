    ...
    <div className={styles.container}>
      ...
      <div className={styles.post}>
        ...
        <div className={styles.textContainer}>
          <h1>Learning how to find the deer sign in less time.</h1>
          <p>Explore expert techniques to swiftly uncover crucial deer sign. Our blog, 'Learning how to find the deer sign in less time,' is your essential hunting tool. Enhance your hunting game and maximize your time in the great outdoors.</p>
        </div>
      </div>
    </div>
  );
